...
HD_PWD='D:/proj/velograph/sparrow_w/xil/sparrow5/sparrow5.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log sparrow5_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sparrow5_top.tcl
