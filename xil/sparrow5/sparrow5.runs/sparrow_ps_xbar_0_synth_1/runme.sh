...
HD_PWD='D:/proj/velograph/sparrow_w/xil/sparrow5/sparrow5.runs/sparrow_ps_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sparrow_ps_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sparrow_ps_xbar_0.tcl
