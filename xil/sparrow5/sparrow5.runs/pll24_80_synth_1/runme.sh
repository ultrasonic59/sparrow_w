...
HD_PWD='D:/proj/velograph/sparrow_w/xil/sparrow5/sparrow5.runs/pll24_80_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll24_80.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll24_80.tcl
