...
HD_PWD='D:/proj/velograph/sparrow_w/xil/sparrow5/sparrow5.runs/mem_2kx16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_2kx16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_2kx16.tcl
