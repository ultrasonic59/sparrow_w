...
HD_PWD='D:/proj/velograph/sparrow_w/xil/sparrow5/sparrow5.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log sparrow5_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sparrow5_top.tcl -notrace
