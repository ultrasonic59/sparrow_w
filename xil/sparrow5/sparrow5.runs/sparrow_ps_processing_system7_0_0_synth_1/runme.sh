...
EAStep vivado -log sparrow_ps_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sparrow_ps_processing_system7_0_0.tcl
