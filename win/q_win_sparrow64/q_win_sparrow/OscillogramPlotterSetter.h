...
protected:
    ...
    inline void PlotVerticalAxi(QPainter & painter);
	inline void PlotHorizontalAxi(QPainter & painter);
///	inline void PlotHorizontalAxi(QPainter& painter, quint16 num_points);
